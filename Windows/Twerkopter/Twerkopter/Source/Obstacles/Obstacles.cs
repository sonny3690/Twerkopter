...
namespace Sway_Chopter.Source.Obstacles
{
    public class Obstacles
    {
        ...
        public void LoadContent(ContentManager content)
        {
            ...
            locations.Add(vc2);
            WreckingBalls.Add(new WreckingBall(new Vector2(vc1.X + size.X - (15 * (size.X / 512)), vc1.Y + (17 * (size.Y / 32))), content));
            WreckingBalls.Add(new WreckingBall(new Vector2(vc2.X + (15 * (size.X / 512)), vc2.Y + (17 * (size.Y / 32))), content));
            ...
            for (int i = 2; i < 7; i++)
            {
                ...
                WreckingBalls.Add(new WreckingBall(new Vector2(vc3.X + size.X - (15 * (size.X / 512)), vc3.Y + (17 * (size.Y / 32))), content));
                WreckingBalls.Add(new WreckingBall(new Vector2(vc4.X + +(15 * (size.X / 512)), vc4.Y + (17 * (size.Y / 32))), content));
        ...
        public void Update(GameTime gameTime, int upSpeed)
        {
            ...
            if (locations[0].Y > viewport.Height)
            {
                ...
                WreckingBalls.Add(new WreckingBall(new Vector2(vc3.X + size.X - (15 * (size.X / 512)), vc3.Y + (17 * (size.Y / 32))), c));
                WreckingBalls.Add(new WreckingBall(new Vector2(vc4.X + (15 * (size.X / 512)), vc4.Y + (17 * (size.Y / 32))), c));
